...
AnalyzeGui::AnalyzeGui() :  m_window_name("Track Learn Detect")
{
...
void AnalyzeGui::showImage(IplImage *image)
{
...
std::string AnalyzeGui::windowName()
{
...
{
    window_name = AnalyzeGui->windowName();
